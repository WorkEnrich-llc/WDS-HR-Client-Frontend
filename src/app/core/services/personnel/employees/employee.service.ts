...
import { CreateEmployeeRequest, CreateEmployeeResponse } from '../../../interfaces/employee';
...
export class EmployeeService {
  ...
  getEmployees(page: number = 1, per_page: number = 10, search: string = ''): Observable<any> {
